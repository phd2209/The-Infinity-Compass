        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          >
            <button
              ...
              className={`
                w-full h-full p-8 rounded-2xl border-2 transition-all duration-300 backdrop-blur-sm
                ${selectedPath === 'wow'
            ...
            >
              <div className="flex flex-col items-center text-center space-y-4">
                ...
                {/* No wallet connection note */}
                <p
                  className="text-xs text-[#F4E8DC]/60 mt-2"
                  style={{ fontFamily: "'Poppins', sans-serif" }}
                >
